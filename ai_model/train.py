...
descricao_competencias = {
    "Competência 1": {
        ...
        "Pontuacoes": {
            ...
            "Bom": "Demonstra dominio insuficiente da modalidade escrita formal da língua portuguesa, com muitos desvios gramaticais. de escolha de registro e de convenções da escrita.",
    ...
    "Competência 2": {
        ...
        "Pontuacoes": {
            ...
            "Mediano": "Desenvolve O tema por meio de argumentação previsivel e apresenta dominio mediano do texto dissertativo-argumentativo, com proposição, argumentação e conclusão.",
            "Bom": "Desenvolve o tema recorrendo a cópia de trechos dos textos motivadores ou apresenta domínio insuficiente do texto dissertativo-argumentativo, não atendendo a estrutura com proposição, argumentação e conclusão.",
    ...
    "Competência 3": {
        ...
        "Pontuacoes": {
            ...
            "Bom": "Apresenta informações, fatos e opiniões relacionados ao tema, mas desorganizados ou contraditórios e limitados aos argumentos dos textos motivadores, em defesa de um ponto de vista.",
    ...
    "Competência 4": {
        ...
        "Pontuacoes": {
            ...
            "Mediano": "Articula as partes do texto, de forma mediana, com inadequações, e apresenta repertório pouco diversificado de recursos ccesivos.",
            "Bom": "Articula as partes do texto, de forma insuficiente, com muitas inadequações e apresenta repertório limitado de recursos coesivos",
    ...
    "Competência 5": {
        ...
        "Pontuacoes": {
            ...
            "Bom": "Elabora, de forma insuficiente, proposta de intervenção relacionada ao tema, ou não articulada com a discussão desenvolvida no texto.",
